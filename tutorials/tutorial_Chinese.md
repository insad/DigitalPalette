...
![相似规则](Chinese/usage/00.png)

2. **单色组**  
您可以使用该规则创建一组相同色调，不同饱和度和明度的色彩。  
![单色规则](Chinese/usage/01.png)

3. **三色组**  
您可以使用该规则创建一组色调三等分的色彩。  
![三色规则](Chinese/usage/02.png)

4. **四色组**  
您可以使用该规则创建一组两两互补的色彩。  
![四色规则](Chinese/usage/03.png)

5. **五色组**  
您可以使用该规则创建一组色调五等分的色彩。  
![五色规则](Chinese/usage/04.png)

6. **补色组**  
您可以使用该规则创建一组互补的色彩。  
![补色规则](Chinese/usage/05.png)

7. **浓度组**  
您可以使用该规则创建一组色调和饱和度相同，仅有明度变化的色彩。  
![浓度规则](Chinese/usage/06.png)

8. **自定组**  
您可以使用该规则创建一组色调、饱和度和明度任意变化的色彩。  
![自定规则](Chinese/usage/07.png)
...
## 示例
1. 将**工作区域**切换到色彩图像视图，打开如下一张图片。这张图片可以在 DigitalPalette 安装路径下 samples 文件夹内找到。  
![图片样本](Chinese/example/H_range.png)

2. 打开图片后 DigitalPalette 的界面如下图所示。  
![打开图片](Chinese/example/0.png)

3. 在**规则窗口**里将色彩调和规则更改为“自定组”，点击**结果窗口**里的第三个色彩方块，然后在图像里点击正中间的紫色区域。可以看到图像里我们点击的地方出现了一个色彩标签，与此同时第三个色彩方块的颜色变为了紫色。按照同样方法，我们可以将其他的色彩方块的颜色分别设置为图像里的其他颜色。  
![定位色彩](Chinese/example/1.png)

4. 将**工作区域**切换到色彩仓库视图，切换后 DigitalPalette 的界面如下图所示。  
![仓库视图](Chinese/example/2.png)

5. 双击最后一个空白色彩组图标，将我们从图片中定位得到的色彩组添加到色彩仓库里。  
![添加色彩](Chinese/example/3.png)

6. 右键单击添加上去的色彩组图标，点击“详情”，打开色彩组信息对话框。  
![查看详情](Chinese/example/4.png)

7. 在对话框里我们可以查看色彩组的颜色和调和规则、修改色彩组的名称和描述。可以看到，这组色彩的调和规则是“自定组”，主要是由蓝色、绿色、紫色、黄色和红色组成，其中紫色是主色彩。点击“名称”后的编辑框，将名称修改为“我的第一份色彩组”。点击“描述”下的编辑框，将描述修改为“这是我从一张 DigitalPalette 图片样本中收集得到的第一份色彩组”。  
![修改信息](Chinese/example/5.png)

8. 将**工作区域**切换到色彩转轮视图，查看这个色彩组中各个颜色的分布状况。可以看到这些色彩程五角对称分布，色彩的饱和度和明度都非常高。  
![查看分布](Chinese/example/6.png)

9. 根据上述色彩分布状况，我们可以将色彩调和规则更改为“五色组”。然后我们可以拖动色彩标签将它们的饱和度和明度都稍稍降低一些，得到另外一组色彩。  
![修改色彩](Chinese/example/7.png)

10. 将**工作区域**切换到色彩仓库视图，按同样方法将这组色彩也添加到色彩仓库中，查看并修改这组色彩的信息。  
![添加色彩](Chinese/example/8.png)
