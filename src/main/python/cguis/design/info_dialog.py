...
class Ui_InfoDialog(object):
    def setupUi(self, InfoDialog):
        ...
        self.name_label.setMinimumSize(QtCore.QSize(100, 30))
        self.name_label.setMaximumSize(QtCore.QSize(100, 30))
        self.name_label.setObjectName("name_label")
        self.gridLayout.addWidget(self.name_label, 1, 1, 1, 1)
        self.name_ledit = QtWidgets.QLineEdit(InfoDialog)
        self.name_ledit.setMinimumSize(QtCore.QSize(150, 30))
        self.name_ledit.setMaximumSize(QtCore.QSize(150, 30))
        ...
        self.rule_label.setMinimumSize(QtCore.QSize(100, 30))
        self.rule_label.setMaximumSize(QtCore.QSize(100, 30))
