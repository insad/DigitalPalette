...
class Script(QWidget):
    ...
    def __init__(self, wget, args):
        ...
        self.sdr_zoom.setMinimumSize(135, 0)
        self.sdr_zoom.setMaximumSize(135, 10000)
        ...
        gbox_grid_layout.addWidget(self.ckb_reserve, 2, 1, 1, 3)

        self.lab_sepr = QLabel(self._enhance_gbox)
        gbox_grid_layout.addWidget(self.lab_sepr, 3, 1, 1, 3)

        self.sdr_sepr = QSlider(self._enhance_gbox)
        self.sdr_sepr.setOrientation(Qt.Horizontal)
        self.sdr_sepr.setMinimumSize(135, 0)
        self.sdr_sepr.setMaximumSize(135, 10000)
        ...
        gbox_grid_layout.addWidget(self.sdr_sepr, 4, 1, 1, 3)

        self.lab_fact = QLabel(self._enhance_gbox)
        gbox_grid_layout.addWidget(self.lab_fact, 5, 1, 1, 3)

        self.sdr_fact = QSlider(self._enhance_gbox)
        self.sdr_fact.setOrientation(Qt.Horizontal)
        self.sdr_fact.setMinimumSize(135, 0)
        self.sdr_fact.setMaximumSize(135, 10000)
        ...
        gbox_grid_layout.addWidget(self.sdr_fact, 6, 1, 1, 3)
    ...
    def emit_enhance(self, value):
        ...
        self.ps_enhance.emit((region, self.sdr_sepr.value() / 1000, self.sdr_fact.value() / 1000, self.ckb_reserve.isChecked()))
